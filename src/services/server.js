...
//     try {
//       const response = await this.instance.post("/packingSlips/pdf", {
//         packingSlipId,
//         orderNumber,
//         dateCreated,
//       });
...
//     try {
//       const res = await this.instance.post("/shipments/pdf", shipmentInfo);
//       return res.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.get("/workOrders/packingQueue");
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.get("/workOrders");
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.put("/packingSlips", {
//         items,
//         customer,
//         orderNumber,
//         destination,
...
//     try {
//       const response = await this.instance.get("/packingSlips/search", {
//         params: {
//           customer: customerId,
//           shipment: shipmentId,
//         },
...
//   ) {
//     try {
//       const response = await this.instance.get("/packingSlips/histSearch", {
//         params: {
//           sortBy,
//           sortOrder,
//           matchOrder,
...
//     try {
//       const response = await this.instance.get("/shipments/queue");
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.get("/shipments");
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.get("/shipments/pending");
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.delete(`/shipments/${id}`);
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.get(`/shipments/${id}`);
//       return response.data;
//     } catch (error) {
...
//   ) {
//     try {
//       const response = await this.instance.get(`/shipments/search`, {
//         params: {
//           sortBy,
//           sortOrder,
//           matchOrder,
...
//     try {
//       const response = await this.instance.get("/packingSlips");
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.delete(`/packingSlips/${id}`);
//       return response.data;
//     } catch (error) {
...
//   ) {
//     try {
//       const response = await this.instance.put("/incomingDeliveries", {
//         internalPurchaseOrderNumber,
//         dueBackDate,
//         sourceShipmentId,
//       });
...
//   ) {
//     try {
//       const response = await this.instance.put("/shipments", {
//         manifest,
//         customer,
//         deliveryMethod,
//         trackingNumber,
...
//     try {
//       const response = await this.instance.get("/incomingDeliveries/queue");
//       return response.data;
//     } catch (error) {
//       console.error("getShippingQueue", error);
//       throw new Error(
...
//         "/incomingDeliveries/allReceived"
//       );
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.post("/incomingDeliveries/receive", {
//         _id,
//         sourcePOType,
//         sourcePOId,
//         linesReceived,
...
//     try {
//       const response = await this.instance.put("/incomingDeliveries/cancel", {
//         _id,
//         reason,
//       });
//       return response.data;
...
//         `/incomingDeliveries/undoReceive`,
//         {
//           deliveryId,
//         }
//       );
...
//     try {
//       const response = await this.instance.get("/packingSlips/pending");
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await this.instance.post(`/storage/upload`, {
//         location,
//       });
...
//     try {
//       const response = await this.instance.post("/qrCode/getTempShipCode", {
...
//     try {
//       const response = await this.instance.put("/tempShipments", {
//         manifest,
//       });
